...
int main(void)
{
    ...
    Ambientpropeties ambient_light;
    while(!window.shouldClose()){
        ...
        cubeShader.setFloat("light.constant", ambient_light.constant);
        cubeShader.setFloat("light.linear", ambient_light.linear);
        cubeShader.setFloat("light.quadratic", ambient_light.quadratic);
        ...
        renderer.Draw(lightCubeVertexArray, lightingCubeShader, 36, camera, model);
